...
class LocationSubscriber(object):
    ...
    def __init__(self, item_name):
        ...
        # callback function.
        self.sub = rospy.Subscriber("/openhab/items/" + self.item_name + "/state", LocationState, self.callback)
...
if __name__ == '__main__':
    ...
    node_name = "LocationSubscriberNode"
    rospy.init_node(node_name, anonymous=True)

    locationSubscriber = LocationSubscriber("testLocation")
