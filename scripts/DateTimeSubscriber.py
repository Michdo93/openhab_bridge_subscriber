...
class DateTimeSubscriber(object):
    ...
    def __init__(self, item_name):
        ...
        # callback function.
        self.sub = rospy.Subscriber("/openhab/items/" + self.item_name + "/state", DateTimeState, self.callback)
...
if __name__ == '__main__':
    ...
    node_name = "DateTimeSubscriberNode"
